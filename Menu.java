...
public class Menu {
    ...
    public void cadastraUsuario() {
        ...
        if (resp == 1) {
            ...
            System.out.print("Defina uma senha para seu usuario: ");
            senha = sc.next();
            admin = new Admin(nome, senha);
            jogo.setAdmin(admin);
        }
    ...
    public void areaAdmin() {
        ...
        while (op1 != 11) {
            ...
            System.out.println("11. Voltar para o menu");
            System.out.print("Digite a opcao desejada: ");

            op1 = leInteiroEntre(1, 11);
    ...
    public void excluiUsuario() {
        ...
        if (jogExcl.equals("0"))
            ...
            Jogador.excluiUser(jogExcl, jogo);
